...
<span style="color: #67E6EC;">K</span>
	...
	<div class="four"> Now just click the submit button and YOUR  TRANSACTION  WILL BE  SUCCESSFUL:)</div> 
</div>
<div class="five">COPYRIGHTS OWNED<br> Have any Query? Feel free to Contact:
</div>

      <span style="color: red; padding: 20px;">

          <br>        
         <a style="margin-left: 10px;color:wheat;"href="https://github.com/SmrutiITB" onmouseover="this.style.color='#00FFFF'" onmouseout="this.style.color='white'" ><i class="fab fa-github fa-2x"></i></a>
         <a style="margin-left:10px;color:wheat;"href="https://www.linkedin.com/in/smruti-singh-908884191/" onmouseover="this.style.color='#00FFFF'" onmouseout="this.style.color='white'"><i class="fab fa-linkedin fa-2x"></i></a>
         </span> 
         </div>
</body>
</html>